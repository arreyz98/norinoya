...
import { 
    SearchCode, ArrowLeft, Search, Calendar as CalendarIcon, Clock, TrendingUp, RefreshCw, FileSpreadsheet, Trash2, X, AlertTriangle, Hash, Sparkles
} from 'lucide-react';
...
export default function SearchLogs({ logs, filters: rawFilters, stats, topSearches }: Props) {
    ...
    // Popover/Dialog open state for calendars
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Keyword Logs Pencarian Buku" />
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-2xl font-bold flex items-center gap-2 text-neutral-900 dark:text-white">
                                ...
                                <span>Log Kata Kunci Pencarian Buku</span>
                            </h1>
                        </div>
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5 ml-10">
                            Riwayat kata kunci yang dicari pengunjung di katalog buku. Otomatis dibersihkan dari spasi berlebih, huruf kecil, serta pencegahan spam kata berulang.
                        </p>
                    </div>
                                ...
                                <TableRow>
                                    <TableCell colSpan={6} className="h-48 text-center">
                                        <div className="flex flex-col items-center justify-center gap-2 text-neutral-400 dark:text-neutral-500">
                                            ...
                                            <p className="text-sm font-medium">Belum ada riwayat kata kunci pencarian</p>
                                            <p className="text-xs text-neutral-400">
                                                Kata kunci pencarian yang diketik pengunjung di katalog buku akan otomatis dicatat di sini.
                                            </p>
                                        </div>
                                    </TableCell>
                                </TableRow>
            ...
            <Dialog open={showClearConfirm} onOpenChange={setShowClearConfirm}>
                <DialogContent className="max-w-md p-6">
                    <DialogHeader className="space-y-2">
                        ...
                        <DialogTitle className="text-base font-bold text-neutral-900 dark:text-white">
                            Bersihkan Riwayat Log Kata Kunci?
                        </DialogTitle>
                        <DialogDescription className="text-xs text-neutral-500 dark:text-neutral-400 space-y-1.5">
                            <p>
                                {startDate || endDate || search ? (
                                    <span>
                                        Data log kata kunci pencarian yang sesuai dengan <strong>filter aktif saat ini</strong> akan dihapus permanen.
                                    </span>
                                ) : (
                                    <span>
                                        <strong>Seluruh ({stats.total_searches.toLocaleString('id-ID')})</strong> data log kata kunci pencarian akan dihapus secara permanen dari database.
                                    </span>
                                )}
                            </p>
                        </DialogDescription>
                ...
                <DialogContent className="max-w-lg w-[92vw] sm:w-[500px] p-6 flex flex-col items-center justify-center">
                    <DialogHeader className="w-full text-center sm:text-center pb-2">
                        ...
                        <DialogDescription className="text-xs text-neutral-500">
                            Pilih tanggal awal untuk memfilter data log kata kunci pencarian.
                        </DialogDescription>
                    </DialogHeader>
            ...
            <Dialog open={isEndDateOpen} onOpenChange={setIsEndDateOpen}>
                <DialogContent className="max-w-lg w-[92vw] sm:w-[500px] p-6 flex flex-col items-center justify-center">
                    <DialogHeader className="w-full text-center sm:text-center pb-2">
                        ...
                        <DialogDescription className="text-xs text-neutral-500">
                            Pilih tanggal akhir untuk memfilter data log kata kunci pencarian.
                        </DialogDescription>
                    </DialogHeader>
