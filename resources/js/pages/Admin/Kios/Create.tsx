...
interface KiosCreateProps {
    partners?: PartnerOption[];
    ageRatings?: EnumOption[];
}

export default function KiosCreate({ partners = [], ageRatings = [] }: KiosCreateProps) {
    const { data, setData, post, processing, errors } = useForm({
        title: '',
        merch_type: 'manga',
        categories: ['manga'] as string[],
        cover_image: '',
        carousel_images: ['', '', '', ''],
        ...
        original_price: '',
        condition_rating: 'S',
        is_preloved: true as boolean,
        is_sold_out: false as boolean,
        rating: 5,
        kios_partner_id: '' as string | number,
        publisher_name: '',
        publisher_id: '',
        author: '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Item Kios & Preloved" />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-neutral-900 dark:text-white">
                                Tambah Item Kios &amp; Preloved Baru
                            </h1>
                            <p className="text-xs text-neutral-500">
                                Buat listing item preloved review atau produk kolaborasi partner merchandise.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4 border-t border-neutral-200 dark:border-neutral-800">
                        ...
                        >
                            ...
                            <span>{processing ? 'Menyimpan...' : 'Simpan Item Kios'}</span>
                        </Button>
                    </div>
                </form>
            </div>
