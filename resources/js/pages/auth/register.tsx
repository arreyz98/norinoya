                                ...
                                <form id="register-form" className="space-y-5" onSubmit={submit}>
                                    ...
                                    <div className="space-y-1.5 pt-1" id="confirm-password-input-group">
                                        ...
                                        {errors.password_confirmation && (
                                            <p className="text-xs text-red-500 pt-1">{errors.password_confirmation}</p>
                                        )}
                                    </div>

                                    {/* Checkbox Syarat & Ketentuan dan Link Login */}
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2" id="terms-agreement-row">
                                        <label
                                        ...
                                        <Link
                                            href="/login"
                                            className="text-xs text-[#112A12] font-semibold hover:underline self-end sm:self-auto"
                                        >
                                            Sudah punya akun?
                                        </Link>
                                    </div>
                                    ...
                                    <div className="pt-4 flex justify-end" id="register-submit-row">
                                        <button
                                            ...
                                            disabled={processing}
                                            className="w-full sm:w-auto bg-[#112A12] hover:bg-[#1c3f1e] disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98] text-white font-medium text-sm px-7 py-3 rounded-full flex items-center justify-center gap-2.5 shadow-md shadow-[#112A12]/20 hover:shadow-lg hover:shadow-[#112A12]/30 transition-all cursor-pointer"
                                        >
                                            <span>{processing ? 'Signing up...' : 'Sign up'}</span>
                                            {!processing && <ArrowRight className="w-4 h-4 stroke-[2.5]" />}
                                        </button>
                                    </div>
                                </form>
                            </div>
