                            ...
                            <div className="max-w-md w-full mx-auto my-auto">
                                <div className="mb-8 text-center sm:text-left">
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Masukkan kredensial Anda untuk masuk ke halaman admin.
                                    </p>
                                </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            {canResetPassword && (
                                                <Link
                                                    ...
                                                    className="text-xs text-slate-500 hover:text-[#112A12] transition-colors hidden"
                                                >
                                                    Lupa password?
                                                </Link>
                                            )}
                                    ...
                                    >
                                        <label className="flex items-center gap-2 cursor-pointer text-slate-600 select-none">
                                            <input
                                                ...
                                                className="w-4 h-4 rounded text-[#112A12] border-slate-300 focus:ring-[#112A12] accent-[#112A12] cursor-pointer"
                                            />
